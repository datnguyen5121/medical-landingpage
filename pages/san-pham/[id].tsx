...
export default function ProductDetail({ product, related }: Props) {
  return (
    <Layout
      title={`${product.seoTitle || product.name} | MediWellness`}
      ...
      <section className="py-14 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-200 text-base mb-8 max-w-xl mx-auto">
            Đội ngũ chuyên gia kỹ thuật của MediWellness sẵn sàng hỗ trợ — demo thiết bị thực tế, báo giá cạnh tranh và bảo hành chính hãng.
          </p>
