...
export default function GioiThieuPage() {
  return (
    <Layout title="Giới Thiệu – MediWellness" description="Tìm hiểu về MediWellness – nhà nhập khẩu và phân phối thiết bị y tế hàng đầu Việt Nam">
      {/* Hero */}
      <section className="bg-blue-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="section-label text-blue-300 mb-2">Về Chúng Tôi</p>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">MediWellness – Đối Tác Tin Cậy Của Ngành Y Tế</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              MediWellness được thành lập với sứ mệnh mang những thiết bị y tế chất lượng cao, tiên tiến nhất từ các nước có nền y tế phát triển về Việt Nam, góp phần nâng cao chất lượng chăm sóc sức khỏe cho người dân.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Danh mục sản phẩm của MediWellness liên tục được mở rộng với hơn 300 sản phẩm từ các thương hiệu hàng đầu thế giới, đáp ứng đầy đủ nhu cầu của các cơ sở y tế từ tuyến cơ sở đến trung ương.
            </p>
          </div>
      ...
      <section className="bg-blue-900 text-white py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold text-white mb-2">Hợp tác cùng MediWellness</h2>
